...
export const SHOP_BADGE_REGISTRY: Record<string, ShopBadgeMeta> = {
  shop_badge_crown:   { id: 'shop_badge_crown',   name: 'Couronne de la Boutique', icon: '👑', tier: 'legendary' },
  shop_badge_diamond: { id: 'shop_badge_diamond', name: 'Diamant de la Boutique',  icon: '💎', tier: 'epic' },
}
